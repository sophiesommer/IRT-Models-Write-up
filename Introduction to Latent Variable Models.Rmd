...
This section focuses on fitting and inspecting the models described above using base R[@BaseR] and the ltm package in R[@Rizopoulos] and then looking . In fact, Rasch, 2-PL, PCM, and GPCM models can all be fit using the gpcm() function, using different values for the "constraint" parameter: 
